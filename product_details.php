...
<head>
    ...
    $filter = " WHERE `id` = '$id' "; 
    $product = mysqli_fetch_assoc(mysqli_query($conn, $sql . $filter));
    // echo $sql . $filter;
    // echo $product['name'];
...
<div class="product">
    ...
    <div class="image">
        <img src="<?php echo $product['picture']?>" alt="picture">
    </div>
    ...
    <div class="details">
        ...
        <form action="actionpage.php?action=addtocart" method="post">
            <input type="hidden" name="pname" value="<?php echo $product['name'] ?>">
            <input type="hidden" name="pcost" value="<?php echo $product['price']?>">
            <input type="hidden" name="pimg" value="<?php  echo $product['picture']?>">
