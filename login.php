...
<body>
    ...
    <div class="loginbody" >
         ...
         <div id="loginform">
            ...
            <form action="actionpage.php?action=login" method="POST" class="form">
                <div class="username">
                ...
                <?php
                    ...
                    {
                        case 'nouser':
                            echo '<b>User record is NOT found in the userinfo table</b>';
                        break;

                        case 'registered':
                            echo '<b>Congrats on becoming part of the HORME family</b>';
                        break;

                        case "cart":
                            echo 'Please login to check out';
                        break;
                    }
